...
NSString *const AsyncSocketException_LIO = @"AsyncSocketException";
NSString *const AsyncSocketErrorDomain_LIO = @"AsyncSocketErrorDomain";
...
@interface AsyncSocket_LIO (Private)
...
**/
@interface AsyncReadPacket_LIO : NSObject
{
  @public
...
@implementation AsyncReadPacket_LIO
...
**/
@interface AsyncWritePacket_LIO : NSObject
{
  @public
	NSData *buffer;
	NSUInteger bytesDone;
...
@implementation AsyncWritePacket_LIO
...
@implementation AsyncSocket_LIO
...
- (void)checkForThreadSafety
{
	if (theRunLoop && (theRunLoop != CFRunLoopGetCurrent()))
	{
		...
		[NSException raise:AsyncSocketException_LIO
...
- (BOOL)createSocketForAddress:(NSData *)remoteAddr error:(NSError **)errPtr
{
	...
	else
	{
		if (errPtr)
		{
			...
			*errPtr = [NSError errorWithDomain:AsyncSocketErrorDomain_LIO code:AsyncSocketCFSocketError userInfo:info];
		}
		return NO;
	}
...
- (void)doAcceptFromSocket:(CFSocketRef)parentSocket withNewNativeSocket:(CFSocketNativeHandle)newNativeSocket
{
	if(newNativeSocket)
	{
		...
		AsyncSocket_LIO *newSocket = [[[[self class] alloc] initWithDelegate:theDelegate] autorelease];
...
- (NSError *)getSocketError
{
	...
	return [NSError errorWithDomain:AsyncSocketErrorDomain_LIO code:AsyncSocketCFSocketError userInfo:info];
}
...
- (NSError *)getAbortError
{
	...
	return [NSError errorWithDomain:AsyncSocketErrorDomain_LIO code:AsyncSocketCanceledError userInfo:info];
}
...
- (NSError *)getConnectTimeoutError
{
	...
	return [NSError errorWithDomain:AsyncSocketErrorDomain_LIO code:AsyncSocketConnectTimeoutError userInfo:info];
}
...
- (NSError *)getReadMaxedOutError
{
	...
	return [NSError errorWithDomain:AsyncSocketErrorDomain_LIO code:AsyncSocketReadMaxedOutError userInfo:info];
}
...
- (NSError *)getReadTimeoutError
{
	...
	return [NSError errorWithDomain:AsyncSocketErrorDomain_LIO code:AsyncSocketReadTimeoutError userInfo:info];
}
...
- (NSError *)getWriteTimeoutError
{
	...
	return [NSError errorWithDomain:AsyncSocketErrorDomain_LIO code:AsyncSocketWriteTimeoutError userInfo:info];
}
                        ...
                        tag:(long)tag
{
	...
	AsyncReadPacket_LIO *packet = [[AsyncReadPacket_LIO alloc] initWithData:buffer
	                                                    startOffset:offset
	                                                      maxLength:length
	                                                        timeout:timeout
	                                                     readLength:0
...
static void MyCFSocketCallback (CFSocketRef sref, CFSocketCallBackType type, CFDataRef address, const void *pData, void *pInfo)
{
	...
	AsyncSocket_LIO *theSocket = [[(AsyncSocket_LIO *)pInfo retain] autorelease];
