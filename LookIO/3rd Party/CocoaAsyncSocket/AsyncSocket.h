...
@class AsyncReadPacket_LIO;
@class AsyncWritePacket_LIO;

extern NSString *const AsyncSocketException_LIO;
extern NSString *const AsyncSocketErrorDomain_LIO;

enum AsyncSocketError_enum
{
...
typedef enum AsyncSocketError_enum AsyncSocketError_LIO;
...
**/
- (void)onSocket:(AsyncSocket_LIO *)sock didAcceptNewSocket:(AsyncSocket_LIO *)newSocket;

/**
 * Called when a new socket is spawned to handle a connection.  This method should return the run-loop of the
 * thread on which the new socket and its delegate should operate. If omitted, [NSRunLoop currentRunLoop] is used.
**/
- (NSRunLoop *)onSocket:(AsyncSocket_LIO *)sock wantsRunLoopForNewSocket:(AsyncSocket_LIO *)newSocket;
...
**/
- (BOOL)onSocketWillConnect:(AsyncSocket_LIO *)sock;
...
**/
- (void)onSocket:(AsyncSocket_LIO *)sock didReadPartialDataOfLength:(NSUInteger)partialLength tag:(long)tag;

/**
 * Called when a socket has completed writing the requested data. Not called if there is an error.
**/
- (void)onSocket:(AsyncSocket_LIO *)sock didWriteDataWithTag:(long)tag;

/**
 * Called when a socket has written some data, but has not yet completed the entire write.
 * It may be used to for things such as updating progress bars.
**/
- (void)onSocket:(AsyncSocket_LIO *)sock didWritePartialDataOfLength:(NSUInteger)partialLength tag:(long)tag;
...
**/
- (NSTimeInterval)onSocket:(AsyncSocket_LIO *)sock
...
@interface AsyncSocket_LIO : NSObject
{
	...
	AsyncReadPacket_LIO *theCurrentRead;
	NSTimer *theReadTimer;
	NSMutableData *partialReadBuffer;
	
	NSMutableArray *theWriteQueue;
	AsyncWritePacket_LIO *theCurrentWrite;
