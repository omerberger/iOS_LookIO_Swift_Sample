...
@interface GCDAsyncSocket_LIO (Private)
...
- (BOOL)doAccept:(int)parentSocketFD
{
	...
	if (delegateQueue)
	{
		...
		dispatch_async(delegateQueue, ^{
			...
			GCDAsyncSocket_LIO *acceptedSocket = [[GCDAsyncSocket_LIO alloc] initWithDelegate:delegate
...
+ (void)addStreamListener:(GCDAsyncSocket_LIO *)asyncSocket
{
	LogTrace();
...
+ (void)removeStreamListener:(GCDAsyncSocket_LIO *)asyncSocket
{
	LogTrace();
	NSAssert([NSThread currentThread] == listenerThread, @"Invoked on wrong thread");
...
{
	GCDAsyncSocket_LIO *asyncSocket = [(GCDAsyncSocket_LIO *)pInfo retain];
