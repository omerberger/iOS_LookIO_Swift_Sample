...
@implementation DAKeyboardControlTableView_LIO
...
{    
    ...
    if([self.delegate respondsToSelector:@selector(keyboardFrameWillChange:from:over:)] && !activeKeyboard.hidden)
    {
        [self.delegate keyboardFrameWillChange:keyboardEndBoundsWindow from:activeKeyboard.frame over:keyboardTransitionDuration];
    }
}
