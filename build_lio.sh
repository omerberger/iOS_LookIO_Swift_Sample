...
#
rm -rf LookIO/build
PATH=/Applications/Xcode.app/Contents/Developer/usr/bin:$PATH xcodebuild -project 'LookIO/LookIO.xcodeproj' -target LookIO -configuration 'Release' -sdk 'iphoneos8.1' clean build ARCHS='armv7 armv7s' IPHONEOS_DEPLOYMENT_TARGET='4.3' TARGET_BUILD_DIR='./build-arm' BUILT_PRODUCTS_DIR='./build-arm' &>$LOG_FILE_ARM
...
PATH=/Applications/Xcode.app/Contents/Developer/usr/bin:$PATH xcodebuild -project 'LookIO/LookIO.xcodeproj' -target LookIO -configuration 'Release' -sdk 'iphoneos8.1' clean build ARCHS='arm64' IPHONEOS_DEPLOYMENT_TARGET='6.0' TARGET_BUILD_DIR='./build-arm64' BUILT_PRODUCTS_DIR='./build-arm64' &>$LOG_FILE_ARM64
...
PATH=/Applications/Xcode.app/Contents/Developer/usr/bin:$PATH xcodebuild -project 'LookIO/LookIO.xcodeproj' -target LookIO -configuration 'Release' -sdk 'iphonesimulator8.1' clean build ARCHS='i386' IPHONEOS_DEPLOYMENT_TARGET='4.3' TARGET_BUILD_DIR='./build-i386' BUILT_PRODUCTS_DIR='./build-i386' &>$LOG_FILE_I386
...
PATH=/Applications/Xcode.app/Contents/Developer/usr/bin:$PATH xcodebuild -project 'LookIO/LookIO.xcodeproj' -target LookIO -configuration 'Release' -sdk 'iphonesimulator8.1' clean build ARCHS='x86_64' VALID_ARCHS='x86_64' IPHONEOS_DEPLOYMENT_TARGET='6.0' TARGET_BUILD_DIR='./build-x86_64' BUILT_PRODUCTS_DIR='./build-x86_64' &>$LOG_FILE_X86_64
